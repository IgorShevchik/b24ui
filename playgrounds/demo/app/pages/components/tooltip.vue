...
<template>
  <div class="relative size-full flex flex-col items-center justify-center ">
    ...
    <div
      class="text-center backdrop-blur-sm bg-(--ui-color-design-outline-na-bg) border-1 border-(--ui-color-design-outline-na-stroke) text-(--ui-color-design-outline-na-content) max-w-[550px] my-[20px] mx-(--content-area-shift) px-[60px] py-[40px] rounded-[24px] flex flex-col items-center justify-center gap-[14px]"
    >
      <B24Tooltip
        :delay-duration="100"
        :content="{ side: 'right' }"
        :text="text.long"
      >
        <div class="cursor-help text-(--ui-color-design-plain-na-content-secondary)">
          <B24Avatar
            :icon="HelpIcon"
            alt="Tooltip"
            size="3xl"
