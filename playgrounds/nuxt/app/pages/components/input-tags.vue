...
<template>
  <PlaygroundPage>
    ...
    <Matrix v-slot="props" :attrs="attrs">
      <B24InputTags v-model="tags" placeholder="Enter tags..." autofocus v-bind="{ ...singleAttrs, ...props }" />
      <B24InputTags v-model="tags" placeholder="Required" required v-bind="{ ...singleAttrs, ...props }" />
      <B24InputTags v-model="tags" placeholder="Underline" underline v-bind="{ ...singleAttrs, ...props }" />
      <B24InputTags v-model="tags" placeholder="No border" no-border v-bind="{ ...singleAttrs, ...props }" />
      <B24InputTags
        v-model="tags"
        placeholder="Tag"
        tag="note"
